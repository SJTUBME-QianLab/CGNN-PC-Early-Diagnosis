...
def main():
    ...
    # Get train patches
    partition, num_part_h_renji, num_part_t_renji, num_part_h_zhongs, num_part_t_zhongs, num_part_renmin, num_part_sixth = read_image_name(
        config, args, logging)
    ...
    test_datasets_zhongs = Patch_Dataset_orisample(config, args, partition, mode='zhongs')
    test_datasets_renmin = Patch_Dataset_orisample(config, args, partition, mode='renmin')
    test_datasets_sixth = Patch_Dataset_orisample(config, args, partition, mode='sixth')
    ...
    save_result.write('healthy people zhongshan(test)' + ',' + str(num_part_h_zhongs) + '\n')
    save_result.write('patient zhongshan(test)' + ',' + str(num_part_t_zhongs) + '\n')
    save_result.write('patient renmin(test)' + ',' + str(num_part_renmin) + '\n')
    save_result.write('patient sixth(test)' + ',' + str(num_part_sixth) + '\n')
    ...
    test_names_renmin, test_probs_patch_renmin, test_feat_patch_renmin = test(test_loader_renmin, model, mode='renmin')
    test_CNN_pred_patch_renmin = predict_binary(test_probs_patch_renmin)

    test_names_zhongs, test_probs_patch_zhongs, test_feat_patch_zhongs = test(test_loader_zhongs, model, mode='zhongs')
    test_CNN_pred_patch_zhongs = predict_binary(test_probs_patch_zhongs)

    test_names_sixth, test_probs_patch_sixth, test_feat_patch_sixth = test(test_loader_sixth, model, mode='sixth')
    test_CNN_pred_patch_sixth = predict_binary(test_probs_patch_sixth)
    ...
    save_patch_probs_pred_test(test_names_zhongs, test_CNN_pred_patch_zhongs, test_probs_patch_zhongs,
                               patch_loc_test_zhongs, test_feat_patch_zhongs, mode='zhongs')
    save_patch_probs_pred_test(test_names_renmin, test_CNN_pred_patch_renmin, test_probs_patch_renmin, patch_loc_test_renmin,
                          test_feat_patch_renmin, mode='renmin')
    save_patch_probs_pred_test(test_names_sixth, test_CNN_pred_patch_sixth, test_probs_patch_sixth, patch_loc_test_sixth,
                               test_feat_patch_sixth, mode='sixth')
